...
class VHDLParserVisitor(ParseTreeVisitor):
    ...
    def visitRule_CompoundConfigurationSpecification(self, ctx:VHDLParser.Rule_CompoundConfigurationSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitRule_ConcurrentConditionalSignalAssignment(self, ctx:VHDLParser.Rule_ConcurrentConditionalSignalAssignmentContext):
        return self.visitChildren(ctx)
    ...
    def visitRule_ConcurrentSelectedSignalAssignment(self, ctx:VHDLParser.Rule_ConcurrentSelectedSignalAssignmentContext):
        return self.visitChildren(ctx)
    ...
    def visitRule_ProtectedTypeInstantiationDefinition(self, ctx:VHDLParser.Rule_ProtectedTypeInstantiationDefinitionContext):
        return self.visitChildren(ctx)
    ...
    def visitRule_SubprogramInstantiationDeclaration(self, ctx:VHDLParser.Rule_SubprogramInstantiationDeclarationContext):
        return self.visitChildren(ctx)
